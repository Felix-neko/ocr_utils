...
DEFAULT_THRESHOLDS: dict[str, tuple[float, str]] = {
    ...
    # Только заголовки. Дуга к длине откалибрована по паку на мере из остатка сдвигов: страниц с
    # ненулевой дугой 240, порог 3·10⁻³ давал 231 (медиана ненулевых 4.9·10⁻³ — почти всё подряд),
    # а страницы порчи пользователя лежат на 5.2–9.4·10⁻³; при 5·10⁻³ остаётся 120 страниц и все
    # четыре страницы пользователя.
