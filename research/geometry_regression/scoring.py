...
DEFAULT_THRESHOLDS: dict[str, tuple[float, str]] = {
    ...
    "parallel_spread_delta_max": (1.5, "parallel"),  # градусы; p97.3; 1966/01 с.78: полки шкафа 0.7° → 3.2°
...
# (СРЕДНИЙ наклон горизонтальных штрихов при ≥ 3 чертах — все черты разом) и погнутый line art.
...
UNFORGIVABLE_MIN_HSTROKE_PAIRS = 3
