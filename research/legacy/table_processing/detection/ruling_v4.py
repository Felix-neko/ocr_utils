...
ЖИВОЙ КОД ПЕРЕЕХАЛ в ``ocr_utils.page_layout.tables.detector``: здесь остался реэкспорт, чтобы стенд исследований
...
from ocr_utils.page_layout.tables.detector import (  # noqa: F401 — реэкспорт для стенда
    TABLE_POLICY,
    POLICY,
