...
Регистр в ``/mnt/SYSTEM`` ЗНАЧИМ: ``/mnt`` — это ext4, и ``/mnt/system`` там отдельный
пустой каталог. Путь со строчными буквами не падает, а тихо уводит вывод на системный диск.
"""
