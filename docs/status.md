...
| external_ocr_services: промпт | `PROMPT_VERSION = 7`; регрессия v2 → v6 на 1966/03: CER к FineReader 0.036 → 0.028 (среднее), эхо формата 9 → 0, сбоев 0 | `ocr_utils/external_ocr_services/__init__.py` | `ocr_utils/external_ocr_services/README.md` |
