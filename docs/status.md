...
- Изгиб линии по кускам LSD (штрих B, в A распавшийся на отрезки под разными углами; v8) — 296 ложных bad на паке: LSD режет ровную толстую линейку на параллельные куски со своими углами, а с B ничего не сравнивалось. Заменён сагиттой по краске вдоль линии в обеих версиях (`research/geometry_regression/bend.py`).
