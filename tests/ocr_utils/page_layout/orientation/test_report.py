...
from ocr_utils.page_layout.orientation.analysis import PageResult
...
from ocr_utils.page_layout.orientation.report import LinkDirError, link_name, write_link_dir
...
def test_contact_sheet_shows_pages_already_turned(tmp_path):
    ...
    from ocr_utils.page_layout.orientation.report import SHEET_COLUMNS, SHEET_TILE_PX, contact_sheet
...
def test_contact_sheet_skips_pages_that_need_no_rotation(tmp_path):
    from ocr_utils.page_layout.orientation.report import contact_sheet
...
def test_candidates_dir_keeps_pages_the_arbiter_rejected(tmp_path):
    ...
    from ocr_utils.page_layout.orientation.report import CANDIDATES_DIR, COMBO_DIR
...
def test_pages_nobody_flagged_stay_out_of_the_candidates_dir(tmp_path):
    from ocr_utils.page_layout.orientation.report import CANDIDATES_DIR
