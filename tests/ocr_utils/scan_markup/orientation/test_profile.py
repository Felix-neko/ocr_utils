...
from ocr_utils.scan_markup.orientation.detectors.profile import detect
from tests.ocr_utils.scan_markup.orientation.synthetic import blank_page, text_page
from tests.ocr_utils.scan_markup.orientation.test_ink_axis import frame_of
