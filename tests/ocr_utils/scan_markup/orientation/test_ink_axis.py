...
from ocr_utils.scan_markup.orientation.detectors.ink_axis import detect, glyph_mask, ink_asymmetry
from tests.ocr_utils.scan_markup.orientation.synthetic import blank_page, line_art_page, text_page
