...
from ocr_utils.scan_cropping.cropping import crop_pixel_exact
from ocr_utils.scan_cropping.geometry import bbox_corners, rotation_matrix
...
class TestGeometry:
    ...
    def test_canvas_is_minimal_aabb_of_rotated_box(self) -> None:
        ...
        corners = bbox_corners(cx, cy, angle, ext)
