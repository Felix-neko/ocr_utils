...
* В Python-коде пиши подробные докстринги (с обязательным объяснием, что делает каждый аргумент) и подробные комменты (чтобы было понятно, что делает каждый фрагмент кода).
