...
Пример:
    uv run python -m ocr_utils.legacy.finger_removal.detect_fingers \\
        --input-dir  /путь/к/сканам \\
        --output-dir ocr_utils/legacy/finger_removal/detected_fingers \\
...
from ocr_utils.legacy.finger_removal.sd_inpaint import (
