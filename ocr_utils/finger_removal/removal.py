...
(``finger_inpaint``). Вызывается из ``ocr_utils.detect_and_crop`` ДО детекции
...
from ocr_utils.finger_removal.masking import build_finger_mask, drop_fingers_on_content, keep_border_components
