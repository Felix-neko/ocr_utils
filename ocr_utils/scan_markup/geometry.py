...
# Разрешение, до которого уменьшаются полосы для разметки. Выбрано так, чтобы кадр
# 600 dpi (3492x6051) стал ~436x756: CVAT листает такие мгновенно, а печать и граница
# фотографии на них ещё различимы.
CVAT_DPI = 75
