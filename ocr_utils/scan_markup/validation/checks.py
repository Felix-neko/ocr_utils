...
from ocr_utils.scan_markup.validation.cases import COLOR_ON_GRAY, DOT_LEADERS, FALSE_POSITIVE, LINEART, MERGED, SPLIT
...
def expectation_holds(defect_key: str, regions) -> bool:
    ...
    if defect_key in (LINEART, FALSE_POSITIVE, DOT_LEADERS):
        return not regions
