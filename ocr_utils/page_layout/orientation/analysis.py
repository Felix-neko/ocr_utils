...
from ocr_utils.page_layout.orientation.detectors import DETECTORS, Detector, Verdict
from ocr_utils.page_layout.orientation.detectors.base import ROTATIONS
...
def _turn_payload(payload: bytes | None, degrees: int) -> bytes | None:
    ...
    from ocr_utils.page_layout.orientation.image_io import GPU_JPEG_QUALITY
