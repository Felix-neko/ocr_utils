...
from ocr_utils.page_layout.orientation.analysis import (
    CANDIDATE_CONFIDENCE,
    PageResult,
    rotation_counts,
    triggering_verdict,
)
from ocr_utils.page_layout.orientation.detectors import ROTATION_NAMES, ROTATIONS
...
def validation_report(trials, detector_names: Sequence[str], root: Path, pages: int, arbiter: str | None = None) -> str:
    ...
    from ocr_utils.page_layout.orientation.validation import accuracy, confusion
