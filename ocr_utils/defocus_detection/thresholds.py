...
(``reports/defocus_validation_si_report.md``, раздел 5): для каждой из десяти сессий с браком
    ...
    for preset in (
        Preset(
            ...
            source=(
                ...
                "Подробности: reports/defocus_validation_si_report.md, разделы 5 и 6"
            ),
        ),
    )
}
